...
public enum UserServiceError {
    ...
    RECIPE_NOT_FOUND("Recipe1 not found.", HttpStatus.NOT_FOUND),
    RECIPE_GROUP_NOT_FOUND("Recipe1 group not found.", HttpStatus.NOT_FOUND),
    INGREDIENT_NOT_FOUND("Recipe1 ingredient not found.", HttpStatus.NOT_FOUND),
